...
class ClosingContainerWarehouseMks extends StatefulWidget {
  const ClosingContainerWarehouseMks({Key? key}) : super(key: key);

  @override
  State<ClosingContainerWarehouseMks> createState() =>
      _ClosingContainerWarehouseMksState();
}

class _ClosingContainerWarehouseMksState
    extends State<ClosingContainerWarehouseMks> {
  ...
  Future<void> _fetchContainers() async {
    ...
    final data = await _warehouseMksService.getContainersToClose();

    setState(() {
      if (data != null && data['data'] != null) {
        _closingContainers = data['data'] ?? [];
      } else {
        _closingContainers = [];
      }
      _isLoading = false;
  ...
  Widget build(BuildContext context) {
    ...
    if (_closingContainers.isEmpty) {
      return SmartRefresher(
        ...
        child: Center(
          child: Text(
            "Tidak ada container untuk di-closing",
